  ...
  <div class="hero-content text-neutral-content text-center">
    <div  data-aos="fade-up" class="max-w-md text-white ">
      ...
      <p class="mb-5">
        ...
        Here in that dashboard you can control your landing page by adding data and custom all the ui content freely and so easy 
      </p>
...
<div class="card bg-base-100 w-100 shadow-xl mb-11  ">
  <figure>
    <div> 
      <h1  data-aos="fade-down" class="text-3xl text-center p-5">Here you can edit ui data or add and delete projects and custom your data without typing any code !</h1>
    </div>
  </figure>
  ...
  <div  data-aos="fade-right">
    <div class="mockup-code mt-11 ">
      <pre
        data-prefix="1"><code><span class="text-red-600">&lt;h1&gt;</span>You dont write any code!<span class="text-red-600">&lt;/h1&gt;</span></code></pre>
    </div>
  </div>
</div>
...
<div class="card bg-base-100 w-100 shadow-xl mb-11">
  <figure  data-aos="fade-up">
    <img
      src="{{ asset('images/Collaborate.svg') }}"
      alt="Shoes" />
  </figure>
  <div  data-aos="fade-down" class="card-body">
    <p class="text-3xl text-center">Here you can control your projects by add , delete and view them and easily access them</p>
...
<div class="card bg-base-100 w-100 shadow-xl mb-11">
  <figure  data-aos="fade-right">
    <img
      src="{{ asset('images/undraw_website_ij0l.svg') }}"
      alt="Shoes" />
  </figure>
  <div  data-aos="fade-down" class="card-body">
    <p class="text-3xl text-center">and you can control your Home Page content by Edit text , Ad servece and alot another data</p>
...
<div class="card bg-base-100 w-100 shadow-xl mb-11">
  <figure  data-aos="fade-right">
    <img
      src="{{ asset('images/undraw_contact_us_re_4qqt (1).svg') }}"
      alt="Shoes" />
  </figure>
  <div  data-aos="fade-down" class="card-body">
    <p class="text-3xl text-center"> you can edit and manage your contact informations and social media links and edit the site widgets </p>
